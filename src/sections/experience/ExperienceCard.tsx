...
export const ExperienceCard: React.FC<Props> = ({ organization, title, desc, tech_stack, duration }) => {
    return <div className="flex flex-col md:flex-row justify-between gap-4 md:gap-8 ">
        ...
        <div className="md:w-4/5">
            ...
            <ul className="flex flex-row flex-wrap gap-2 mt-4">
                {tech_stack.map((t, i) => <li key={i} className="px-4 py-2 rounded-lg border border-black dark:border-white">{t}</li>)}
            </ul>
