        ...
        <div className="max-w-screen-lg">
            ...
            <div className="grid gap-6 md:grid-cols-3 mt-16">
                <ProjectCard
                    ...
                    tech_stack={[]}
                    preview={["Preview", "https://play.google.com/store/apps/details?id=com.dxn.wallpaperx.ui&pli=1"]}
                ...
                <ProjectCard
                    ...
                    tech_stack={[]}
                    preview={["Preview", "https://github.com/thedroiddiv/RawAudioRecorder"]}
                    github={["GitHub", "https://github.com/thedroiddiv/RawAudioRecorder"]}
                />
                <ProjectCard
                    ...
                    tech_stack={[]}
                    preview={["Preview", "https://github.com/thedroiddiv/Social_IIITNR"]}
